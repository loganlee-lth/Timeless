...
INSERT INTO "public"."product"
  ("name", "shortDescription", "longDescription", "price", "category", "inventoryQuantity", "imageUrl", "createdAt")
VALUES
  ('Slim-fit polo shirt', 'Optical White', 'A crisp and cool garment that will accompany your daily outfits with comfort and performance.', 2500, 'polos', 5, 'https://i.imgur.com/FYklSCg.jpg', now());
